...
if (role === "trainer") {
  ...
  if (!userStatus) {
    ...
    setError("Your account status could not be determined.");
    notify.error("Your account status could not be determined.");
  ...
  try {
    ...
    // Pending / Under Review / Rejected → Application page
    if (
    ...
    console.error(
      "LOAD TRAINER APPLICATION AFTER LOGIN ERROR:",
      applicationError
    );
