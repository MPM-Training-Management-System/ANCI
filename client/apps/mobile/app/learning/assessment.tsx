...
export default function AssessmentScreen() {
  ...
  const assessmentId =
    getParamValue(params.assessmentId);
  ...
  const handleStartAssessment =
    useCallback(async () => {
      ...
      try {
        ...
        // If backend returns answers from a
        // resumed attempt, restore them.
     

        // Keep latest result available.
        if (latestResult) {
          ...
          <View style={styles.resultCard}>
            ...
            <View style={styles.resultDetails}>
              <View style={styles.resultDetailRow}>
                <Text style={styles.resultDetailLabel}>
                  Correct Answers
                </Text>
      ...
      <View style={styles.questionScreen}>
        ...
        <View style={styles.questionHeader}>
          ...
          <View style={styles.questionHeaderCenter}>
            <Text
              style={styles.questionHeaderTitle}
              numberOfLines={1}
            >
              {participantAssessment?.title ??
                "Assessment"}
