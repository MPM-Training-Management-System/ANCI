...
namespace server.Migrations
{
    ...
    [Migration("20260811114608_AddParticipantApplication")]
    partial class AddParticipantApplication
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("server.Models.ParticipantApplicationModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ParticipantApplications");
                });
            ...
            modelBuilder.Entity("server.Models.ParticipantApplicationModel", b =>
                {
                    b.HasOne("server.Models.UserModel", "User")
                        .WithOne("ParticipantApplication")
                        .HasForeignKey("server.Models.ParticipantApplicationModel", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("server.Models.UserModel", b =>
                {
                    ...
                    b.Navigation("ParticipantApplication");
