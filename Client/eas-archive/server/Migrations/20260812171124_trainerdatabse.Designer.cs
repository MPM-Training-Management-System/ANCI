...
namespace server.Migrations
{
    ...
    [Migration("20260812171124_trainerdatabse")]
    partial class trainerdatabse
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("server.Models.UserApplicationModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("server.Models.UserApplicationModel", b =>
                {
                    b.HasOne("server.Models.UserModel", "User")
                        .WithOne("Application")
                        .HasForeignKey("server.Models.UserApplicationModel", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
